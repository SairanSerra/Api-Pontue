...
3 - Rode o comando no diretório raíz do projeto (docker-compose up) <br/>
4 - Enter no docker desktop no terminal do projeto rodando de rode o seguinte comando (php artisan migrate --force) <br/>
